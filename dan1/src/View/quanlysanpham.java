...
public class quanlysanpham extends javax.swing.JPanel {
    ...
    void resetTableFW() {
        ...
        for (chitietsanpham x : ctsanphams) {
            String sizesp = new String();
            sizesp += x.getSizesp();;
            modelFW.addRow(new Object[]{
                x.getMasp(), x.getTensp(), sizesp.replaceAll("\\s", ""), x.getMauSacsp(), x.getDanhMuc(), x.getThuongHieu()
            });
        }
    ...
    void fillFromSanpham() {
        ...
        SetAnh(sp.getAnhSP());
        lblFileName.setText(sp.getAnhSP());
        getSelectedSPMauSac();
        getSelectedSPSize();
