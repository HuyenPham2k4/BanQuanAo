...
public class hoadon {
    ...
    public hoadon(int id, int idnv, int id_kh, String sdt, String tenkh, String mavocher, String thoigian, String ghichu, int ttthanhtoan, int tongtien, int trangthai) {
        this.id = id;
        this.idnv = idnv;
        this.id_kh = id_kh;
        this.sdt = sdt;
